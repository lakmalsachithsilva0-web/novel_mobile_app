...
/// Galatea-style profile (restored working version; full Inkitt-matching UI continues next).
              ...
              body: TabBarView(
                ...
                children: [
                  ListView(
                    ...
                    children: [
                      Text('Chapters read: $_chaptersRead'),
                      Text('Social karma: $_karma'),
                      Text('Day streak: $_streak'),
                      const SizedBox(height: 12),
                      Text(_bio),
