...
/// Galatea-style profile (working version; full Inkitt UI expansion continues).
              ...
              body: TabBarView(
                ...
                children: [
                  ListView(
                    ...
                    children: [
                      _statRow('CHAPTERS READ', '$_chaptersRead', Icons.menu_book_rounded, const Color(0xFF9B59B6)),
                      const SizedBox(height: 10),
                      _statRow('SOCIAL KARMA', '$_karma', Icons.campaign_outlined, brand),
                      const SizedBox(height: 10),
                      _statRow('DAY READING STREAK', '$_streak', Icons.blur_on, const Color(0xFF5B9BD5)),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text(_s(s['description']), maxLines: 2, overflow: TextOverflow.ellipsis),
                              onTap: () {
                  ...
                  _wall.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            return ListTile(
                              title: Text(
                                _s(m['sender_name'] ?? m['username'] ?? 'User'),
                              ),
                              subtitle: Text(
